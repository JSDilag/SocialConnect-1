            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    if (stu.startsWith("stu_"))
                                        {
                                            stu = stu.substring(4);
                                            score=request.getParameter("stu_"+stu);
                                            DBConnection.ExecUpdateQuery("update Transcript set Grade='"+
                                                    score.trim()+"' where CrsCode='"+
                                                    crscode.trim()+"' and StudId='"+
                                                    stu.trim()+"'");
                    }
                                    }
                                %>
                                
                                Grades are Submitted successfully! 
                                
                                <br/>
                                <a href="FacultyInformation.jsp"> Back To The Dashboard </a>
