         ...
         { <%   String select[] = request.getParameterValues("MessageCheck"); 
                if (select != null && select.length != 0) 
                  {  for (int i = 0; i < select.length; i++) 
                     {   DBConnection.ExecQuery("delete from Message where MessageID="+select[i]+")");
                     }
                  }
            %> 
         }
        ...
        <div class="innerBackground">
          <div class="container">
            <br><br>
                  ...
                  <input type="submit" value="Delete Selected" class="btn btn-primary" onclick="DeleteMessage()">
                  <div class="table-responsive">
                     <table class="table table-bordered table-hover">
                        ...
                        <tbody>  
                         <%   rs = DBConnection.ExecQuery("select * from Message where Receiver ="+ID);   
